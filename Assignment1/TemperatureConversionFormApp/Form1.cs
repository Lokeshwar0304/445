...
namespace TemperatureConversionFormApp
{
    public partial class Form1 : Form
    {
        ...
        TempConvService.Service1Client tempConvService = new TempConvService.Service1Client();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int c2f_value = tempConvService.c2f(Convert.ToInt32(Math.Round(Double.Parse(textBox1.Text), MidpointRounding.AwayFromZero)));
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                int f2c_value = tempConvService.f2c(Convert.ToInt32(Math.Round(Double.Parse(textBox1.Text), MidpointRounding.AwayFromZero)));
